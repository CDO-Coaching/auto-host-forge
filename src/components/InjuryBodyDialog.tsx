...
const MARKERS: Marker[] = [
  ...
  { zone: "Pectoral", bx: 306, by: 500, sideable: true },
  { zone: "Biceps", bx: 232, by: 560, sideable: true },
  { zone: "Coude", bx: 210, by: 648, sideable: true },
  { zone: "Avant-bras / poignet", bx: 200, by: 725, sideable: true },
  { zone: "Abdominaux", bx: 366, by: 625 },
  { zone: "Hanche (flexeur)", bx: 318, by: 770, sideable: true },
  { zone: "Pubis / aine", bx: 366, by: 815 },
  { zone: "Adducteurs", bx: 352, by: 900, sideable: true },
  { zone: "Quadriceps", bx: 312, by: 970, sideable: true },
    ...
    <Dialog open={open} onOpenChange={(o) => { if (!o) onCancel?.(); onOpenChange(o); }}>
      <DialogContent className="max-w-[94vw] sm:max-w-md max-h-[94vh] overflow-y-auto p-4">
        ...
        <div className="w-full rounded-2xl overflow-hidden bg-black/20">
          {view === "front"
            ? <BodyPlate vb={[-120, 205, 980, 1250]} point={point} onClickPoint={handleClickPoint} />
            : <BodyPlate vb={[960, 205, 1180, 1250]} point={point} onClickPoint={handleClickPoint} />}
        </div>
