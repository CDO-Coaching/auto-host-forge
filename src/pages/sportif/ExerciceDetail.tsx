                ...
                <div className="border-t pt-3 space-y-2.5">
                  ...
                  {!reportActual ? (
                    <button type="button"
                      ...
                      className="w-full h-11 rounded-xl border border-primary/40 bg-primary/[0.06] text-foreground/90 text-sm font-semibold flex items-center justify-center gap-2 active:scale-[0.99] transition-all">
                      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg>
